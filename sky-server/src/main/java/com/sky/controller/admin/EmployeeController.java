...
public class EmployeeController {
    ...
    @PostMapping
    @ApiOperation("新增员工")
    public Result<Employee> addNewEmployee(@RequestBody EmployeeDTO employeeDTO) {
    ...
    public Result<String> enableOrDisableEmployeeAccounts(@PathVariable Integer status, Long id) {

        log.info("启用或禁用员工账号：status:{},id:{}", status, id);

        employeeService.enableOrDisableEmployeeAccounts(status, id);
